...
# Variables
model.sell = model.DevotedAcreage = Var(model.VENTES, bounds=(0.0, model.VMAX))
model.SuperQuotaQuantity
model.SubQuotaQuantity
...
model.QuantitySuperQuotaSel = Var(model.CROPS, bounds=(0.0, None))
model.QuantitySuperQuotaSold = Var(model.CROPS, bounds=(0.0, None))

model.QuantityPurchased = Var(model.CROPS, bounds=(- model.QuantitySuperQuotaSell, model.QuantitySuperQuotaSell))
